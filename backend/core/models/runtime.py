...
class CognitiveEventType(str, Enum):
    ...
    # Goal-level lifecycle events (Phase 4.2)
    ...
    GOAL_WAITING_FOR_USER = "GOAL_WAITING_FOR_USER"
    ...
    # World state & situational awareness events (Phase 4.4)
    WORLD_STATE_CREATED = "WORLD_STATE_CREATED"
    WORLD_STATE_UPDATED = "WORLD_STATE_UPDATED"
    WORLD_CONDITION_CHANGED = "WORLD_CONDITION_CHANGED"
    WORLD_CONDITION_EXPIRED = "WORLD_CONDITION_EXPIRED"
    WORLD_STATE_CONFLICT = "WORLD_STATE_CONFLICT"
    WORLD_STATE_CONFLICT_RESOLVED = "WORLD_STATE_CONFLICT_RESOLVED"
    WORLD_ENTITY_ADDED = "WORLD_ENTITY_ADDED"
    WORLD_ENTITY_REMOVED = "WORLD_ENTITY_REMOVED"

    # Event-Driven Autonomy events (Phase 4.5)
    AUTONOMY_EVENT_INGESTED = "AUTONOMY_EVENT_INGESTED"
    AUTONOMY_EVENT_CLASSIFIED = "AUTONOMY_EVENT_CLASSIFIED"
    AUTONOMY_RELEVANCE_EVALUATED = "AUTONOMY_RELEVANCE_EVALUATED"
    AUTONOMY_TRIGGER_MATCHED = "AUTONOMY_TRIGGER_MATCHED"
    AUTONOMY_DECISION_PRODUCED = "AUTONOMY_DECISION_PRODUCED"
    AUTONOMY_ACTION_DISPATCHED = "AUTONOMY_ACTION_DISPATCHED"
    AUTONOMY_TRIGGER_SUPPRESSED = "AUTONOMY_TRIGGER_SUPPRESSED"
    AUTONOMY_POLICY_DENIED = "AUTONOMY_POLICY_DENIED"

    # Anticipatory Planning events (Phase 4.6)
    ANTICIPATION_EVALUATED = "ANTICIPATION_EVALUATED"
    ANTICIPATION_ACCEPTED = "ANTICIPATION_ACCEPTED"
    ANTICIPATION_REJECTED = "ANTICIPATION_REJECTED"
    ANTICIPATION_INVALIDATED = "ANTICIPATION_INVALIDATED"
    ANTICIPATION_EXPIRED = "ANTICIPATION_EXPIRED"
    ANTICIPATION_DECISION_PRODUCED = "ANTICIPATION_DECISION_PRODUCED"
    ANTICIPATION_ACTION_DISPATCHED = "ANTICIPATION_ACTION_DISPATCHED"
    ANTICIPATION_POLICY_DENIED = "ANTICIPATION_POLICY_DENIED"
    ANTICIPATION_DUPLICATE_SUPPRESSED = "ANTICIPATION_DUPLICATE_SUPPRESSED"

    # Situation Fusion events (Phase 5.0b)
    SITUATION_CREATED = "SITUATION_CREATED"
    SITUATION_UPDATED = "SITUATION_UPDATED"
    SITUATION_MERGED = "SITUATION_MERGED"
    SITUATION_EXPIRED = "SITUATION_EXPIRED"
    SITUATION_CONFLICT_DETECTED = "SITUATION_CONFLICT_DETECTED"
    SITUATION_SUPPRESSED = "SITUATION_SUPPRESSED"

    # Central Input Gateway events (Phase 5.0c)
    INGRESS_OBSERVATION_ACCEPTED = "INGRESS_OBSERVATION_ACCEPTED"
    INGRESS_OBSERVATION_REJECTED = "INGRESS_OBSERVATION_REJECTED"
    INGRESS_DUPLICATE_SUPPRESSED = "INGRESS_DUPLICATE_SUPPRESSED"
    INGRESS_RATE_LIMITED = "INGRESS_RATE_LIMITED"

    # Device & Agent Gateway events (Phase 5.0d)
    DEVICE_REGISTERED = "DEVICE_REGISTERED"
    DEVICE_UNREGISTERED = "DEVICE_UNREGISTERED"
    DEVICE_STATUS_UPDATED = "DEVICE_STATUS_UPDATED"
    DEVICE_CAPABILITY_REGISTERED = "DEVICE_CAPABILITY_REGISTERED"
    DEVICE_DISPATCH_REQUESTED = "DEVICE_DISPATCH_REQUESTED"
    DEVICE_DISPATCH_ACCEPTED = "DEVICE_DISPATCH_ACCEPTED"
    DEVICE_DISPATCH_FAILED = "DEVICE_DISPATCH_FAILED"
    DEVICE_ADAPTER_RESOLVED = "DEVICE_ADAPTER_RESOLVED"
    DEVICE_ADAPTER_ERROR = "DEVICE_ADAPTER_ERROR"

    # Central Orchestration events (Phase 5.0e)
    CENTRAL_ORCHESTRATION_CYCLE_STARTED = "CENTRAL_ORCHESTRATION_CYCLE_STARTED"
    CENTRAL_ORCHESTRATION_CYCLE_COMPLETED = "CENTRAL_ORCHESTRATION_CYCLE_COMPLETED"
    CENTRAL_ORCHESTRATION_LOOP_DETECTED = "CENTRAL_ORCHESTRATION_LOOP_DETECTED"
    CENTRAL_ORCHESTRATION_OBSERVATION_REINGESTED = "CENTRAL_ORCHESTRATION_OBSERVATION_REINGESTED"

    # Server Lifecycle events (Phase 6.1)
